...
const gameId = 3008;
const gameCode = "fortune-toucan";
const minChip = 0.1;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.FortuneToucanStartReq";
let receiveSpinRoute = "com_protocol.FortuneToucanStartRsp";
