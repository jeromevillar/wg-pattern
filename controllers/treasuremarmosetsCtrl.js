...
const Model = db.treasuremarmosets;
...
const gameId = 3015;
const gameCode = "treasure-marmosets";
const minChip = 0.3;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.TreasureMarmosetsStartReq";
let receiveSpinRoute = "com_protocol.TreasureMarmosetsStartRsp";
