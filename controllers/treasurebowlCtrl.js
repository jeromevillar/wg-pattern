...
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinTreasureBowlStartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3019;
const gameCode = "treasure-bowl";
const minChip = 0.1;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.TreasureBowlStartReq";
let receiveSpinRoute = "com_protocol.TreasureBowlStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp": {
                        ...
                        await sendSpinTreasureBowlStartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
                    case receiveSpinRoute: {
                        ...
                        if (pattern.gameDataInfo.gameMode == 5 || pattern.gameDataInfo.gameMode == 4) {
