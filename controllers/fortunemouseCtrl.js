...
const gameId = 3042;
const gameCode = "fortunemouse";
const minChip = 0.1;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.MrTurtleStartReq";
let receiveSpinRoute = "com_protocol.MrTurtleStartRsp";
