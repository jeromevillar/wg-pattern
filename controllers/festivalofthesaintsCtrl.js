...
const Model = db.festivalofthesaints;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinFestivalSaintsStartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3018;
const gameCode = "festival-of-the-saints";
const minChip = 0.3;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.FestivalSaintsStartReq";
let receiveSpinRoute = "com_protocol.FestivalSaintsStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinFestivalSaintsStartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
