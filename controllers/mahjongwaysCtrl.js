...
const Model = db.mahjongways;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinMahjongWaysStartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3029;
const gameCode = "mahjong-ways";
const minChip = 0.2;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.MahjongWaysStartReq";
let receiveSpinRoute = "com_protocol.MahjongWaysStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinMahjongWaysStartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
                    case receiveSpinRoute: {
                        ...
                        if (pattern.gameDataInfo.spins.length > 1) {
