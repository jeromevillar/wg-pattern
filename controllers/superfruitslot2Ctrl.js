...
const Model = db.superfruitslot2;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinSuperFruitSlot2StartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3030;
const gameCode = "superfruitslot2";
const minChip = 0.09;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.SuperFruitsSlot2StartReq";
let receiveSpinRoute = "com_protocol.SuperFruitsSlot2StartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinSuperFruitSlot2StartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
