...
const Model = db.dragonvstiger;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinDragonVsTigerStartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3014;
const gameCode = "dragon-vs-tiger";
const minChip = 0.2;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.DragonVsTigerStartReq";
let receiveSpinRoute = "com_protocol.DragonVsTigerStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinDragonVsTigerStartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
