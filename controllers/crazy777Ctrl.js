...
const Model = db.crazy777;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinCrazyStartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3026;
const gameCode = "crazy777";
const minChip = 0.15;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.CrazyStartReq";
let receiveSpinRoute = "com_protocol.CrazyStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinCrazyStartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
