...
const Model = db.fishingmaster;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinFishingMasterBetInfoReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3022;
const gameCode = "fishing-master";
const minChip = 0.1;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.FishingMasterBetInfoReq";
let receiveSpinRoute = "com_protocol.FishingMasterBetInfoRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinFishingMasterBetInfoReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
