...
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinWuKongStartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3025;
const gameCode = "wukong";
const minChip = 0.2;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.WuKongStartReq";
let receiveSpinRoute = "com_protocol.WuKongStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinWuKongStartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
