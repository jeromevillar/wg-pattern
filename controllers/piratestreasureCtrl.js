...
const Model = db.piratestreasure;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpin, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3024;
const gameCode = "pirates-treasure";
const minChip = 0.5;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.PiratesTreasureStartReq";
let receiveSpinRoute = "com_protocol.PiratesTreasureStartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpin(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
