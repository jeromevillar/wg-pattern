...
const Model = db.dragonstreasure2;
const WebSocket = require('ws');
const path = require("path");
const { v4: uuidv4 } = require('uuid');
const {getLaunchUrl} = require("../utils/launchGame");
const {loadProto} = require("../utils/proto");
const {delay, startPing, stopPing, sendMessage, receiveMessage, sendClientLoginReq, sendDivisionActivityReq, sendSpinDragonTreasure2StartReq, saveSpin} = require("../utils/common");

const PROTO_PATH = path.join(__dirname, "../utils/com_protocol.proto");

const gameId = 3028;
const gameCode = "dragons-treasure2";
const minChip = 0.1;

let sendSpinCmd = 12011;
let sendSpinRoute = "com_protocol.DragonTreasure2StartReq";
let receiveSpinRoute = "com_protocol.DragonTreasure2StartRsp";
            ...
            if (data) {
                ...
                switch (route) {
                    case "com_protocol.ClientLoginSingleGameRsp":{
                        ...
                        await sendSpinDragonTreasure2StartReq(ws, root, sendSpinCmd, sendSpinRoute, minChip, totalRound);
                        break;
                    }
